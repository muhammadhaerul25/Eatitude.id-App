...
class FoodScanner:
    @staticmethod
    def generate_food_nutrition_estimation(image_path: str) -> dict:
        prompt = PromptTemplates.get_prompt_for_food_scanner()
    ...
    @staticmethod
    def generate_food_nutrition_estimation_from_base64(base64_image: str) -> dict:
        """
